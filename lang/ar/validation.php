...
return [
    ...
    */
    ...
    'min' => [
        'array' => 'يجب أن يحتوي حقل :attribute على ما لا يقل عن :min من العناصر.',
    ...
    'min_digits' => 'يجب أن يحتوي حقل :attribute على ما لا يقل عن :min من الأرقام.',
    ...
    'password' => [
        ...
        'uncompromised' => 'الـ :attribute المعطى قد ظهر في تسرب بيانات. الرجاء اختيار :attribute مختلف.',
    ],
    ...
    */
    ...
    'custom' => [
        ...
        'captcha' => [
            'required' => 'الرجاء التحقق من أنك لست روبوتًا.',
            'captcha' => 'فشل التحقق من CAPTCHA. الرجاء المحاولة مرة أخرى.',
        ],
    ],
