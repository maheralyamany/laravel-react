...
return [
     ...
     * }
     */
    'cookie_prefix' => 'scify_laravel_react_p_',
    ...
    'categories_collapsed_by_default' => false, // Set to false to initially collapse the optional categories
    ...
    'cookies' => [
        'strictly_necessary' => [
            [
                ...
                'name' => 'scify_laravel_react__cookies_consent',
            ...
            [
                'name' => 'scify_laravel_react__session',
